  ...
  return (
    <SectionLayout>
      <div className="mx-auto space-y-6 p-8 lg:space-y-16">
          ...
          <div className="mx-auto max-w-[420px] lg:max-w-none">
            ...
            <div className="space-y-4 border-b border-[#E8ECEF] py-6 lg:hidden">
              <div className="flex h-10 gap-2 lg:h-[52px]">
                <div className="flex h-full w-1/2 items-center justify-between rounded bg-[#F5F5F5] px-2 md:w-2/5 lg:px-4">
                  <MinusIcon
                    stroke="#141718"
        ...
        <div className="mx-auto max-w-[420px] space-y-10 lg:max-w-none">
